var backgroundScene,monkey,ObstacleGroup,BananaGroup,score,monkeyImage,monkeyAnimation,bananaImage,obstacleImage,invisibleGround,obstacleImage;
var gameState, lives, gameOverImg;
function preload(){
  ...
  monkeyImage=loadImage("Monkey_10.png");
...
if (backgroundScene.x > 300 ){
  ...
  if(gameState === "play"){
    ...
    monkey.addImage("monkey img", monkeyImage);
